import{u as i,o as n,m as c,a as u,b as r,c as l,d,h as m,i as h}from"./index-XPyUtBwB.js";const f={__name:"ApiView",props:{admin:Boolean},setup(p){const s=p,o=h(null),a=i();let e;return n(()=>{e=c(o.value,"api",s.admin,a)}),u(()=>e?.canLeave()),r(()=>e?.dispose()),(q,t)=>(l(),d("section",{ref_key:"root",ref:o,id:"api-view",class:"page-view"},[...t[0]||(t[0]=[m(`<div class="section-title"><div><h1>API 使用说明</h1><p>使用管理员会话或 API Key 批量上传与管理图片。</p></div></div><div class="api-grid"><section class="settings-panel"><h2>私有上传</h2><p>请求头传入 API Key，表单字段为 <code>file</code> 或 <code>image</code>。适合脚本和自动化客户端。</p><pre><code>curl -H &#39;X-API-Key: sk-...&#39; \\
  -F &#39;file=@photo.jpg&#39; \\
